...
const ResidentProfileDocuments = ({ clientId }) => {
  ...
  useEffect(() => {
    ...
    fetch(`https://demo-mds-backend.vercel.app/resident-documents/client/${clientId}`, {
      headers: {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://demo-mds-backend.vercel.app/resident-documents", {
        method: "POST",
        body: fd,
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      if (res.ok) {
        ...
        // refresh data
        const refreshRes = await fetch(`https://demo-mds-backend.vercel.app/resident-documents/client/${clientId}`, {
  ...
  const deleteDoc = async (id) => {
    ...
    await fetch(`https://demo-mds-backend.vercel.app/resident-documents/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
    });
