  ...
  useEffect(() => {
    ...
    const fetchShifts = async () => {
      try {
        ...
        const res = await fetch(`https://demo-mds-backend.vercel.app/shifts/staff/${staffId}`, {
...
const saveShift = async () => {
  ...
  try {
    const res = await fetch("https://demo-mds-backend.vercel.app/shifts", {
      method: "POST",
  ...
  const deleteShift = async (id) => {
    ...
    try {
      const res = await fetch(`https://demo-mds-backend.vercel.app/shifts/${id}`, {
        method: "DELETE",
      });
