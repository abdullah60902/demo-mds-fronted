...
const StaffProfileDocuments = ({ staffId }) => {
  ...
  useEffect(() => {
    ...
    fetch(`https://demo-mds-backend.vercel.app/staff-documents/staff/${staffId}`, {
      headers: {
...
.then((data) => {
  ...
  const handleUpload = async (e) => {
    ...
    const res = await fetch("https://demo-mds-backend.vercel.app/staff-documents", {
      method: "POST",
      body: fd,
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const deleteDoc = async (id) => {
    ...
    await fetch(`https://demo-mds-backend.vercel.app/staff-documents/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
    });
