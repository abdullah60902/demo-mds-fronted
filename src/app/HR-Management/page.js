...
const Page = () => {
  ...
  const handleSubmit3 = (e) => {
    ...
    const request = editingUserId
      ? axios.put(`https://demo-mds-backend.vercel.app/hr/${editingUserId}`, payload, config)
      : axios.post(`https://demo-mds-backend.vercel.app/hr`, payload, config);
    ...
    request
      .then((res) => {
        ...
        return axios.get("https://demo-mds-backend.vercel.app/hr", config);
      })
      .then((res) => {
  ...
  useEffect(() => {
    const fetchHR = async () => {
      try {
        const token = localStorage.getItem("token");
        const res = await axios.get("https://demo-mds-backend.vercel.app/hr", {
  ...
  const handleDelete = (id) => {
    ...
    const token = localStorage.getItem("token");
    axios
      .delete(`https://demo-mds-backend.vercel.app/hr/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
