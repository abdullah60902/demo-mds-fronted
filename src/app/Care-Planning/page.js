...
const [searchQueryform, setSearchQueryform] = useState("");
    ...
    const fetchAlerts = async () => {
      try {
        ...
        const res = await axios.get(
          "https://demo-mds-backend.vercel.app/carePlanning/alerts",
          {
  ...
  const handleMarkReviewed = async (id) => {
    try {
      ...
      const res = await axios.put(
        `https://demo-mds-backend.vercel.app/carePlanning/${id}/mark-reviewed`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleSubmitCare = (e) => {
    ...
    const request = editingCareId
      ? axios.put(
          `https://demo-mds-backend.vercel.app/carePlanning/${editingCareId}`,
          formData,
          config
        )
      : axios.post(`https://demo-mds-backend.vercel.app/carePlanning`, formData, config);
    ...
    request
      .then((res) => {
        ...
        return axios.get("https://demo-mds-backend.vercel.app/carePlanning", config);
      })
      .then((res) => {
  ...
  const handleDeleteCare = (id) => {
    ...
    const token = localStorage.getItem("token");
    axios
      .delete(`https://demo-mds-backend.vercel.app/carePlanning/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://demo-mds-backend.vercel.app/carePlanning", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
        let plans = res.data;
  ...
  const handleAccept = async (id) => {
    ...
    try {
      ...
      await axios.put(
        `https://demo-mds-backend.vercel.app/carePlanning/${id}`,
        {
          status: "Accepted",
          signature: dataURL,
        },
