...
const Page = () => {
  ...
  useEffect(() => {
    const fetchPatients = async () => {
      ...
      try {
        const res = await axios.get("https://demo-mds-backend.vercel.app/client", {
    ...
    try {
      setLoading(true);
      const res = await axios.get(`https://demo-mds-backend.vercel.app/medications/client/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
...
const handleSubmitCare = async (e) => {
  ...
  try {
    ...
    if (editingCareId) {
      response = await axios.put(
        `https://demo-mds-backend.vercel.app/medication-administration/${editingCareId}`,
        data,
        config
      );
    } else {
      response = await axios.post(
        "https://demo-mds-backend.vercel.app/medication-administration",
        data,
        config
      );
    }
  ...
  const handleDeleteCare = async (id) => {
    ...
    const token = localStorage.getItem("token");
    try {
      await axios.delete(`https://demo-mds-backend.vercel.app/medication-administration/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
    ...
    axios
      .get("https://demo-mds-backend.vercel.app/medication-administration", {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => {
