...
useEffect(() => {
  ...
  fetch(`https://demo-mds-backend.vercel.app/hr/${id}`, {
  ...
  fetch(`https://demo-mds-backend.vercel.app/training/staff/${id}`, {
    headers: { Authorization: `Bearer ${token}` }
  })
    .then(res => res.json())
...
useEffect(() => {
  ...
  const executeBulkExport = async () => {
    ...
    try {
        ...
        const freshStaffRes = await fetch(`https://demo-mds-backend.vercel.app/staff/${id}`, config);
        ...
        if (selectedExportModules.includes("training")) {
            ...
            const res = await fetch(`https://demo-mds-backend.vercel.app/training/staff/${id}`, config);
        ...
        if (selectedExportModules.includes("performance")) {
            ...
            const res = await fetch(`https://demo-mds-backend.vercel.app/performance/staff/${id}`, config);
        ...
        if (selectedExportModules.includes("documents")) {
            ...
            yPos += 8;
            const res = await fetch(`https://demo-mds-backend.vercel.app/staff-documents/staff/${id}`, config);
        ...
        if (selectedExportModules.includes("assessment")) {
            const res = await fetch(`https://demo-mds-backend.vercel.app/assessment/staff/${id}`, config);
    ...
    <div className="relative w-20 h-20 sm:w-24 sm:h-24 mb-3 sm:mb-0">
      ...
      <input
        ...
        onChange={async (e) => {
          ...
          const res = await fetch(`https://demo-mds-backend.vercel.app/hr/${id}/photo`, {
            method: "PUT",
...
>
 ...
 <Link href="/HR-Management">
  ...
  onClick={async () => {
    ...
    const res = await fetch(`https://demo-mds-backend.vercel.app/hr/${id}`, {
      method: "DELETE",
      headers: {
